...
@app.post("/register", responses={201: {"description": "User registered successfully"}, 400: {"description": "User already exists"}, 500: {"description": "Internal server error"}})
async def register(user: User):
    if get_user(fake_users_db, username=user.email) is not None:
    ...
    try:
        ...
        response_headers = {"Set-Cookie": f"token={access_token}; HttpOnly; Secure; SameSite=None; Max-Age=600"}
